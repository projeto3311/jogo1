			...
			if (GUILayout.Button("Register"))
			{
				...
				else
				{
					if (password == rePass)
					{
						...
						WWW w = new WWW("projetopesquisa.ufsmlablin.com/cadastro.php", form);
		...
		else
		{
			...
			if (GUILayout.Button("Login"))
			{
				...
				else
				{
					...
					form.AddField("user", user);
					form.AddField("password", password);
					WWW w = new WWW("http://projetopesquisa.ufsmlablin.com/login.php", form);
